...
export class TourService {
    ...
    const doc = await this.placeModel.findOneAndUpdate(
      { source: 'tour', externalId: detail.id },
      {
        $set: {
          ...
          lclsSystm1Name: detail.lclsSystm1Name ?? undefined,
          lclsSystm2: detail.lclsSystm2 ?? undefined,
          lclsSystm2Name: detail.lclsSystm2Name ?? undefined,
          lclsSystm3: detail.lclsSystm3 ?? undefined,
          lclsSystm3Name: detail.lclsSystm3Name ?? undefined,
  ...
  private toStoredTourPlaceCard(place: PlaceDocument): PlaceCard {
    return {
      ...
      lclsSystm1Name: place.lclsSystm1Name ?? null,
      lclsSystm2: place.lclsSystm2 ?? null,
      lclsSystm2Name: place.lclsSystm2Name ?? null,
      lclsSystm3: place.lclsSystm3 ?? null,
      lclsSystm3Name: place.lclsSystm3Name ?? null,
      name: place.name,
  ...
  private toTourPlaceCardPayload(card: PlaceCard) {
    ...
    return {
      ...
      lclsSystm1Name: card.lclsSystm1Name ?? undefined,
      lclsSystm2: card.lclsSystm2 ?? undefined,
      lclsSystm2Name: card.lclsSystm2Name ?? undefined,
      lclsSystm3: card.lclsSystm3 ?? undefined,
      lclsSystm3Name: card.lclsSystm3Name ?? undefined,
      tags,
    };
  }
}
